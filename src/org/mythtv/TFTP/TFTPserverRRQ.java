    ...
    public TFTPserverRRQ(TFTPread request) throws TftpException {
        try {
            ...
            File srcFile = new File(fileName);
             if (srcFile.length() > 512*65536)
                throw new TftpException("File is too long: " + fileName + ": " + srcFile.length());
            ...
            if (srcFile.exists() && srcFile.isFile() && srcFile.canRead()) {
                ...
                throw new TftpException("access violation or file not found: " + fileName);
                ...
                for (int blkNum = 1; bytesRead == TFTPpacket.maxTftpPakLen; blkNum++) {
                    ...
                    while (timeoutLimit != 0) {
                        try {
                            ...
                            /*
                             * System.out.println("confirm blk num " +
                             * a.blockNumber()+" from "+a.getPort());
                             */
                            break;
